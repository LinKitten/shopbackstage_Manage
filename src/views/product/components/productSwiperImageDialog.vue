<template>
  ...
  >
    ...
    >
      ...
      <el-form-item > 
        <el-button type="primary" @click="handleConfirm"  >添加产品轮播图片</el-button>
      </el-form-item>
    </el-form>

    <el-table :data="tableData" stripe style="width: 100%">
      <el-table-column type="index" width="50" />
      <el-table-column prop="image" label="产品轮播图片" >
...
watch(
  ...
  //监听的回调方法
  () => {
    form.value.productId = prop.imageDialogValue.id;
